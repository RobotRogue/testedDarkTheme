javascript: (function() {
                          ...
                          var blockAdSpam = document.querySelector(
                            "aside.l-lastcol section.well"
                          );
                          if (blockAdSpam) {
                            blockAdSpam.setAttribute(
                              "style",
                              "display: none"
                            );
                          }

                          var oolaya = document.querySelector(
                            'iframe[src*="ooyala"]'
                          );
                          if (oolaya) {
                            oolaya.setAttribute(
                          ...
                          var killNextVideoBox = document.querySelector(
                            "section.more"
                          );
                          if (killNextVideoBox) {
                          ...
                          if (articlePremiumContainer) {
                            for (
                              var i = 0;
                              i <
                              articlePremiumContainer.length;
                              i++
                            ) {
                              if (
                                articlePremiumContainer[
                                  i
                                ].classList.contains(
                                  "is_premium_content"
                                )
                                ...
                                var premiumFlag = document.createElement(
                                  "div"
                                );
                                premiumFlag.innerHTML =
                                  "PREMIUM";
                          ...
                          var hasFeatureVideo = document.querySelector(
                            ".featured-publishable-video"
                          );
                          if (hasFeatureVideo) {
                            ...
                            if (premVidContainer) {
                              var premiumTile = document.createElement(
                                "div"
                              );
                              ...
                              premVidContainer.appendChild(
                                premiumTile
                              );
                            }

                            var premiumFlag = document.querySelector(
                              ".prem-flag"
                            );
                            if (premiumFlag) {
                              premiumFlag.remove();
                            ...
                            if (vidPlayer) {
                              vidPlayer.setAttribute(
                                "style",
                                "width: 1050px; height: 610px;"
                              );
                            }

                            var videoBlurb = document.querySelector(
                              "aside.l-col-fixed"
                            );
                            if (videoBlurb) {
                              videoBlurb.className =
                                "l-col-fluid";
                            }
